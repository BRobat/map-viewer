...
function addEventListeners() {
       ...
       for (let i = 0; i < regions[floor].length; i++) {
        ...
        x.addEventListener('touchstart', () => activateRegion(i, regions[floor]))
        x.addEventListener('click', () => activateRegion(i, regions[floor]))
    }
...
function activateRegion(i, regions) {
    activeRegion = i
    text.innerHTML = regions[floor][i].name
}
